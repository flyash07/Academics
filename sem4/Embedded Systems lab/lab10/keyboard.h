...
/*int main(void){
	...
	LPC_GPIO0->FIODIR |= 0x00003C00; //made output P2.10 to P2.13 (rows)                   0000 0011 1100 0000 0000
	LPC_GPIO1->FIODIR &= 0xFFFFFF0F; //made input P1.23 to P1.26(cols)      1111 1000 0111 1111 1111 1111 1111 1111   
